...
import {
    ...
    BLOCKS_TAB_INDEX,
    COSTUMES_TAB_INDEX,
    SOUNDS_TAB_INDEX, TESTS_TAB_INDEX
...
const mapStateToProps = state => {
    ...
    return {
        ...
        testsTabVisible: state.scratchGui.editorTab.activeTabIndex === TESTS_TAB_INDEX,
...
const mapDispatchToProps = dispatch => ({
    ...
    onActivateTestsTab: () => dispatch(activateTab(TESTS_TAB_INDEX)),
